  ...
  CALL unsorted_pruned_list%Init(pruned_counter-1)
  ...
  CALL matAB%InitFromTripletList(sorted_pruned_list, mat_c_rows, mat_c_columns)
  CALL sorted_pruned_list%Destruct

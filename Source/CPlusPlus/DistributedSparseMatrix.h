...
public:
  ...
  void FillFromTripletList(const TripletList<double> &triplet_list);
...
public:
  ...
  void GetTripletList(TripletList<double> &triplet_list);
  ...
  void GetMatrixBlock(TripletList<double> &triplet_list, int start_row,

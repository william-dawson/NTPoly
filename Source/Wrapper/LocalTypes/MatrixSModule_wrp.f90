...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  PURE SUBROUTINE ConstructMatrixFromTripletList_lsr_wrp(ih_this, ih_triplet_list, &
       & rows, columns) bind(c,name="ConstructMatrixFromTripletList_lsr_wrp")
    INTEGER(kind=c_int), INTENT(INOUT) :: ih_this(SIZE_wrp)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  PURE SUBROUTINE ConstructZeroMatrix_lsr_wrp(ih_this, &
       & rows, columns) bind(c,name="ConstructZeroMatrix_lsr_wrp")
    INTEGER(kind=c_int), INTENT(INOUT) :: ih_this(SIZE_wrp)
    INTEGER(kind=c_int), INTENT(IN) :: columns
    INTEGER(kind=c_int), INTENT(IN) :: rows
    !! Local Data
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  PURE SUBROUTINE GetMatrixRows_lsr_wrp(ih_this, rows) bind(c,name="GetMatrixRows_lsr_wrp")
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  PURE SUBROUTINE GetMatrixColumns_lsr_wrp(ih_this, columns) bind(c,name="GetMatrixColumns_lsr_wrp")
    INTEGER(kind=c_int), INTENT(IN) :: ih_this(SIZE_wrp)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  PURE SUBROUTINE ExtractMatrixColumn_lsr_wrp(ih_this, column_number, ih_column_out) &
       & bind(c,name="ExtractMatrixColumn_lsr_wrp")
    INTEGER(kind=c_int), INTENT(IN) :: ih_this(SIZE_wrp)
